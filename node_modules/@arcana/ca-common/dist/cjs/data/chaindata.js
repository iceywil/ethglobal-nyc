...
exports.ChaindataMap = exports.Chaindata = exports.RPCURLMap = void 0;
...
class _RPCURLMap {
    dataset = [
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 421614),
            "https://arb-sepolia.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 11155420),
            "https://opt-sepolia.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 80002),
            "https://polygon-amoy.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 84532),
            "https://base-sepolia.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 137),
            "https://polygon-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 42161),
            "https://arb-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 10),
            "https://opt-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 8453),
            "https://base-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 1),
            "https://eth-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 534352),
            "https://scroll-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 59144),
            "https://linea-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 43114),
            "https://avax-mainnet.g.alchemy.com/v2/PfaswrKq0rjOrfYWHfE9uLQKhiD4JCdq",
        ],
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 999),
            "https://rpc.hyperliquid.xyz/evm",
        ], // Alchemy doesn't support this.
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 8217),
            "https://go.getblock.io/d7094dbd80ab474ba7042603fe912332",
        ], // Alchemy doesn't support this.
        [(0, chainid_1.encodeChainID36)(definition_1.Universe.ETHEREUM, 50104), "https://rpc.sophon.xyz"], // Alchemy doesn't support this.
        [
            (0, chainid_1.encodeChainID36)(definition_1.Universe.FUEL, 9889),
            "https://omniscient-fittest-pallet.fuel-mainnet.quiknode.pro/3193ae52f2522af1a4357a482e475e019857f02b/v1/graphql",
        ],
    ];
    map = new Map(this.dataset.map((z) => [(0, viem_1.toHex)(z[0]), z[1]]));
    get(key) {
        return this.map.get((0, viem_1.toHex)(key.toBytes()));
    }
}
exports.RPCURLMap = new _RPCURLMap();
class CurrencyMap {
    map = new Map();
...
class _ChaindataMap {
    map = new Map();
    constructor() {
        for (const datum of exports.Chaindata) {
            this.map.set((0, viem_1.toHex)(datum.ChainID.toBytes()), datum);
        }
    }
    get(key) {
        return this.map.get((0, viem_1.toHex)(key.toBytes()));
...
exports.ChaindataMap = new _ChaindataMap();
