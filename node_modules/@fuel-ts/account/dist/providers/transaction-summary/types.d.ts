...
import type { Transaction, Input, Output, TransactionType, OutputChange, OutputVariable } from '@fuel-ts/transactions';
...
export type GraphqlTransactionStatus = SubmittedStatus | SuccessStatus | FailureStatus | SqueezedOutStatus | PreconfirmationSuccessStatus | PreconfirmationFailureStatus | null;
 ...
 * @hidden
 */
export type GqlTransactionStatusesNames = 'FailureStatus' | 'SubmittedStatus' | 'SuccessStatus' | 'SqueezedOutStatus' | 'PreconfirmationSuccessStatus' | 'PreconfirmationFailureStatus';
/**
 * @hidden
 */
