...
var keccak256 = /* @__PURE__ */ __name((data) => keccak_256(data), "keccak256");
...
var bufferFromString = /* @__PURE__ */ __name((string, encoding = "base64") => {
  switch (encoding) {
    case "utf-8": {
...
var pbkdf2 = /* @__PURE__ */ __name((password, salt, iterations, keylen, algo) => {
...
var stringFromBuffer = /* @__PURE__ */ __name((buffer, encoding = "base64") => {
  switch (encoding) {
    case "utf-8": {
...
var encryptJsonWalletData = /* @__PURE__ */ __name(async (data, key, iv) => {
...
var decryptJsonWalletData = /* @__PURE__ */ __name(async (data, key, iv) => {
  const subtle = crypto2.subtle;
...
var computeHmac = /* @__PURE__ */ __name((algorithm, key, data) => {
...
var randomUUID = /* @__PURE__ */ __name(() => crypto2.randomUUID(), "randomUUID");
