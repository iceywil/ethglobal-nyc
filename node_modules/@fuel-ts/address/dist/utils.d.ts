 ...
 * @hidden
 */
export declare const fromEvmAddressToB256: (address: string) => B256Address;
/**
 ...
 * @hidden
 */
export declare const fromPublicKeyToB256: (publicKey: string) => B256Address;
/**
 ...
 * @hidden
 */
export declare const fromDynamicInputToB256: (address: string | Address) => B256Address;
