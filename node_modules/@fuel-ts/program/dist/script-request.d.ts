import type { TransactionResultReturnDataReceipt, TransactionResultRevertReceipt, CallResult, TransactionResultReceipt, TransactionResultReturnReceipt, TransactionResultScriptResultReceipt, DecodedLogs } from '@fuel-ts/account';
 ...
 */
export declare function decodeCallResult<TResult>(callResult: CallResult, decoder: (scriptResult: ScriptResult) => TResult, logs?: DecodedLogs['logs'], groupedLogs?: DecodedLogs['groupedLogs']): TResult;
/**
 ...
 */
export declare function callResultToInvocationResult<TReturn>(callResult: CallResult, call: CallConfig, logs?: DecodedLogs<unknown>['logs'], groupedLogs?: DecodedLogs<unknown>['groupedLogs']): TReturn;
