...
import type { CallResult, CoinQuantity, CoinQuantityLike, TransactionResponse, TransactionResult, TransactionType, AbstractAccount, Provider, DecodedLogs, PreConfirmationTransactionResult } from '@fuel-ts/account';
